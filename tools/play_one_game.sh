...
./playgame.py --player_seed 42 --end_wait=0.25 --verbose --log_dir game_logs --turns 200 --map_file tools/maps/maze/maze_2.map "$@" "java -jar ../archive/rebelxt01.jar" --verbose -e
